...
class Product(models.Model):
    ...
    unpublish_product = models.BooleanField(default=False, verbose_name='статус публикации')
    owner = models.ForeignKey(CustomUser, help_text='Укажите владельца продукта', null=True, blank=True, verbose_name='Владелец', on_delete=models.CASCADE)
